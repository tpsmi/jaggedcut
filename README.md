...
The notebook also writes a self-contained HTML explorer, in which every element
of the dendrogram can be clicked to see a sample of the photographs beneath it —
selected clusters, merge points above the cut, unreported groupings below it, and
the junctions where photographs left the tree.
