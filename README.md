...
| `hdbscan_tree_explorer.html` | Zenodo, as above (optional; see below) |
...
connection and no server. Download it from Zenodo and open it in a browser. It is
about 32 MB, which is why it is deposited there rather than kept in this
repository.
